...
@Configuration
@EnableJpaRepositories(basePackages = {"com.permata.migrate.repository.mysql2"},
...
public class MySql2Config {
	...
	public LocalContainerEntityManagerFactoryBean db3EntityManager() {
		...
		em.setPackagesToScan(new String[]{"com.permata.migrate.entity.mysql2"});
	...
	public DataSource db3Datasource() {
		...
		dataSource.setDriverClassName(
				env.getProperty("mysql2.datasource.driver-class-name"));
		dataSource.setUrl(env.getProperty("mysql2.datasource.url"));
		dataSource.setUsername(env.getProperty("mysql2.datasource.username"));
		dataSource.setPassword(env.getProperty("mysql2.datasource.password"));
		return dataSource;
	}
